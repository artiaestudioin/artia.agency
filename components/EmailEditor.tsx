...
export default function EmailEditor({
  ...
  useEffect(() => {
    ...
    const initEditor = async () => {
      ...
      } catch { /* silencioso — el editor igual arranca */ }
      ...
      const editor: GrapesjsEditor = grapesjs.init({
        ...
        // ── Asset Manager conectado a Supabase ─────────────────────────────
        assetManager: {
          assets: supabaseAssets,
          // Cuando el usuario sube desde el Asset Manager de GrapesJS
          ...
          upload: '', // vacío para que use uploadFile personalizado
        },
